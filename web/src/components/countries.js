...
// country_arr.map(function(item) {
//   return '<option value=" + item + ">' + item + '</option>'
// });

const country_drop_down =
...
<select onChange={this.handleChange('phase')}>
  ...
  <option value="Cote d 'Ivoir">Cote d' Ivoire < /option>
  <option value="roati">Croatia</option> "
  ...
  <option value selected="USA">USA</option>
...
module.exports = country_drop_down
